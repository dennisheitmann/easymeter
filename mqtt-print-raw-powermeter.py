            ...
            if c_int == crc_int:
                ...
                if V2_8_0 != V2_8_0_prev:
                    if V2_8_0 < 99999:
                        V2_8_0_prev_timestamp = datetime.datetime.utcnow()
                        print('2.8.0: ' + str(V2_8_0))
                if V1_8_0_prev_timestamp < datetime.datetime.utcnow() - datetime.timedelta(minutes=15):
                    if V1_8_0 < 99999:
                        V1_8_0_prev_timestamp = datetime.datetime.utcnow()
                        print('1.8.0: ' + str(V1_8_0))
                if V2_8_0_prev_timestamp < datetime.datetime.utcnow() - datetime.timedelta(minutes=15):
                    if V2_8_0 < 99999:
                        V2_8_0_prev_timestamp = datetime.datetime.utcnow()
                        print('2.8.0: ' + str(V2_8_0))
